...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Checklist = __webpack_require__(158);
	...
	var App = (function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentDidMount() {
	      _libChecklistStore2['default'].listen(this._onChange.bind(this));
	    }
	  }, {
	    key: 'componentWillUnmount',
	    value: function componentWillUnmount() {
	      _libChecklistStore2['default'].unlisten(this._onChange.bind(this));
	    }
	  }, {
	    key: '_onChange',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChecklistItem = __webpack_require__(159);
	...
	var ChecklistItem = (function (_Component) {
	  ...
	  _createClass(ChecklistItem, [{
	    ...
	    value: function render() {
	      ...
	      var referrer = function referrer(ref, i) {
	        return _react2['default'].createElement(
	          'a',
	          { key: 'referrer_' + i, href: ref },
	          ref
	        );
	      };
	      var referrers = function referrers(ref, i) {
	        if (refs === undefined) {
	          return false;
	        } else {
	          return _react2['default'].createElement(
	    ...
	    value: function _notes() {
	      if (this.state.editing) {
	        ...
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'button',
	            { onClick: this._deleteNote.bind(this) },
	            '×'
	          )
	        );
	      } else {
